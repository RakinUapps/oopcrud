...
if($status){
    ...
    $mail->SetFrom('siriusbitm@gmail.com','User Management');
    $mail->AddReplyTo("siriusbitm@gmail.com","User Management");
    $mail->Subject    = "Your Account Activation Link";
    $message = "
       Please click this link to verify your account:
       http://localhost/www/UserManagement/views/SEIPXXXX/User/Profile/emailverification.php?email=".$_POST['email']."&email_token=".$_POST['email_token'];
